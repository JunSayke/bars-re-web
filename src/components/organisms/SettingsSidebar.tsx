  ...
  return (
    <div className="p-4 flex flex-col h-full">
      ...
      <div className="flex flex-col gap-2">
        ...
        <Link href="/settings/profile" className={`flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all ${isProfile ? 'bg-gradient-to-r from-[#6b21a8] to-[#5b13ec] text-white shadow-lg' : 'text-[#a492c9] hover:bg-[#221933] hover:text-white'}`}>
        ...
        <Link href="/settings/security" className={`flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all ${isSecurity ? 'bg-gradient-to-r from-[#6b21a8] to-[#5b13ec] text-white shadow-lg' : 'text-[#a492c9] hover:bg-[#221933] hover:text-white'}`}>
      ...
      <div className="border-t border-[#2f2348] pt-4">
        <a className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-red-400 hover:bg-red-500/10 transition-colors" href="#">
