# editor-responsive-layout Specification

## Purpose
TBD - introduced by change workspace-editor-responsive-zoom. Implement responsive container widths and padding in editor shell.
