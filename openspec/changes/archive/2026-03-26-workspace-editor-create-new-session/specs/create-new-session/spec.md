...
#### Scenario: New session appears in list on next visit
- **WHEN** the user creates a session and then navigates back to the Workspaces page
- **THEN** the newly created session appears in the session list
